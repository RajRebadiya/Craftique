        ...
        <div class="row gutters-10">
            ...
            <div class="col-lg-4">
                <div class="border p-3 pr-5 rounded mb-3 position-relative">
                    ...
                    <?php if($address->area): ?>
                    <div >
                        <span class="w-50 fw-600"><?php echo e(translate('Area')); ?>:</span>
                        <span class="ml-2"><?php echo e(optional($address->area)->name); ?></span>
                    </div>
                    <?php endif; ?>
                    <div>
...
<form action="<?php echo e(route('user.change.email')); ?>" method="POST">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-2">
                    <label><?php echo e(translate('Your New Email')); ?></label>
                </div>
                <div class="col-md-10">
            ...
            <div class="row update-div">
                <div class="col-md-2">
                    <label class="fs-14"><?php echo e(translate('Verification Code')); ?></label>
                </div>
                <div class="col-md-10">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control rounded-0" placeholder="<?php echo e(translate('Enter Your Verification Code')); ?>" name="code" value="" disabled />
                        <div class="input-group-append">
                           
                        </div>
                    </div>
                    <div class="form-group mb-0 text-right">
                        <button type="submit" class="btn btn-primary rounded-0 w-150px mt-3" disabled ><?php echo e(translate('Update Email')); ?></button>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $('.new-email-verification').on('click', function() {
        ...
        $.post('<?php echo e(route('user.email.update.verify.code')); ?>', {_token:'<?php echo e(csrf_token()); ?>', email: email}, function(data){
    ...
    function edit_address(address) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                <?php if(get_active_countries()->count() == 1): ?>
                        get_states(<?php echo e(get_active_countries()[0]->id); ?>);
                <?php endif; ?>
            }
        });
    }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('seller.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Murli_Devlopment\resources\views/seller/profile/index.blade.php ENDPATH**/ ?>