    ...
    <div class="container">
        <div class="row">
                    ...
                    <?php if(get_setting('show_language_switcher') == 'on'): ?>
                        <li class="list-inline-item dropdown mr-4 lang-visibility" id="lang-change">
                            ...
                            <a href="javascript:void(0)" class="dropdown-toggle fs-12 py-2 top-text-color-visibility"
                                style="color: <?php echo e($topHeaderTextColor); ?>" data-toggle="dropdown"
                                data-display="static">
                                ...
                                <?php $__currentLoopData = get_all_active_language(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <a href="javascript:void(0)" data-flag="<?php echo e($language->code); ?>"
                                            class="dropdown-item text-dark <?php if($system_language->code == $language->code): ?> active <?php endif; ?>">
                        ...
                        <li class="list-inline-item dropdown ml-auto ml-lg-0 mr-0 currency-visibility" id="currency-change">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right dropdown-menu-lg-left">
                                <?php $__currentLoopData = get_all_active_currency(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <a class="dropdown-item <?php if($system_currency->code == $currency->code): ?> active <?php endif; ?> text-dark"
            ...
            <div class="col-6 text-right d-none d-lg-block top-text-color-visibility"
                style="color: <?php echo e($topHeaderTextColor); ?>">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu fs-12 p-0 mt-1">
                                    <a class="dropdown-item py-2 px-2 text-dark"
                                        ...
                                        <?php echo e(translate('Login to Seller')); ?>
                    ...
                    <?php else: ?>
                        <li class="list-inline-item ml-3 p-2 mr-0 pr-0 top-text-color-visibility"
                            ...
                            <a class="fs-12 d-inline-block py-2 top-text-color-visibility"
                                style="color: <?php echo e($topHeaderTextColor); ?>">
                                <span class="helpline-label" style="display:none;"><?php echo e(translate('Helpline')); ?>:</span>
...
<header
    class="<?php if(get_setting('header_stikcy') == 'on'): ?> sticky-top <?php endif; ?> z-1020 middle-background-color-visibility stikcy-header-visibility"
    style="background-color: <?php echo e(get_setting('middle_header_bg_color')); ?>">
    <!-- Search Bar -->
        ...
        <div class="container">
            <div class="d-flex align-items-center">
                            ...
                            <a class="dropdown-toggle no-arrow text-secondary fs-12" data-toggle="dropdown"
                                ...
                                <span class="position-relative d-inline-block">
                                    ...
                                    <?php if(Auth::check() && count($user->unreadNotifications) > 0): ?>
                                        <span
                                            class="badge badge-primary badge-inline badge-pill absolute-top-right--10px unread-notification-count"><?php echo e(count($user->unreadNotifications)); ?></span>
                                    <?php endif; ?>
                                </span>
                            </a>
                ...
                <div class="d-none d-xl-block ml-auto mr-0">
                    <?php if(auth()->guard()->check()): ?>
                        <span class="d-flex align-items-center nav-user-info py-20px <?php if(isAdmin()): ?> ml-5 <?php endif; ?>"
                            id="nav-user-info">
                            <!-- Image -->
                            ...
                            <!-- Name -->
                            <h4 class="h5 fs-14 fw-700 ml-2 mb-0 middle-text-color-visibility" style="color: <?php echo e($middleHeaderTextColor); ?>"><?php echo e($user->name); ?></h4>
                        </span>
                    <?php else: ?>
                        <!--Login & Registration -->
                        <span class="d-flex align-items-center nav-user-info ml-3">
                            <!-- Image -->
                            <span
                                class="size-40px rounded-circle overflow-hidden border d-flex align-items-center justify-content-center nav-user-img middle-text-color-visibility" style="color: <?php echo e($middleHeaderTextColor); ?>">
                            ...
                            <a href="<?php echo e(route('user.login')); ?>"
                                class="opacity-60 hov-opacity-100 fs-12 d-inline-block border-right border-soft-light border-width-2 pr-2 ml-3 middle-text-color-visibility" style="color: <?php echo e($middleHeaderTextColor); ?>"><?php echo e(translate('Login')); ?></a>
                            <a href="<?php echo e(route('user.registration')); ?>"
                                
                                class="opacity-60 hov-opacity-100 fs-12 d-inline-block py-2 pl-2 middle-text-color-visibility" style="color: <?php echo e($middleHeaderTextColor); ?>"><?php echo e(translate('Registration')); ?></a>
                        </span>
                    <?php endif; ?>
                </div>
            </div>
                        ...
                        <ul class="list-unstyled no-scrollbar mb-0 text-left">
                            ...
                            <li class="user-top-nav-element border border-top-0" data-id="1">
                                <a href="<?php echo e(route('logout')); ?>"
                                    ...
                                    <span
                                        class="user-top-menu-name has-transition ml-3 text-dark"><?php echo e(translate('Logout')); ?></span>
                                </a>
                            </li>
                        </ul>
                    </div>
    ...
    <!-- Menu Bar -->
    <div class="d-none d-lg-block position-relative h-50px bottom-background-color-visibility" style="background-color: <?php echo e(get_setting('bottom_header_bg_color')); ?>">
                ...
                <div class="d-none d-xl-block all-category has-transition bg-black-10" id="category-menu-bar">
                    <div class="px-3 h-100"
                        ...
                        <div class="d-flex align-items-center justify-content-between bottom-text-color-visibility" style="color: <?php echo e($bottomHeaderTextColor); ?>">
                            <div>
                                <span class="fw-700 fs-16 mr-3"><?php echo e(translate('Categories')); ?></span>
                                <a href="<?php echo e(route('categories.all')); ?>" class="text-reset categoriesAll">
                                    <span
                                        class="d-none d-lg-inline-block animate-underline-white">(<?php echo e(translate('See All')); ?>)</span>
                                </a>
                            </div>
                                    ...
                                    <li class="list-inline-item mr-0 animate-underline-white">
                                        <a href="<?php echo e(json_decode(get_setting('header_menu_links'), true)[$key]); ?>"
                                            class="fs-13 px-3 py-3 d-inline-block fw-700 header_menu_links hov-bg-black-10 bottom-text-color-visibility
                                                                    <?php if(url()->current() == json_decode(get_setting('header_menu_links'), true)[$key]): ?> active <?php endif; ?>" style="color: <?php echo e($bottomHeaderTextColor); ?>">
...
</header><?php /**PATH C:\laragon\www\Murli_Devlopment\resources\views/header/header1.blade.php ENDPATH**/ ?>