                                                ...
                                                <div class="px-20px pb-10px display-none" id="preorder_cagegories_box">
                                                    <div id="category_filter_preorder"
                                                        ...
                                                        <ul class="hummingbird-treeview-converter2 list-unstyled"
                                                            ...
                                                            <?php $__currentLoopData = $preorder_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php if($category->products_count > 0): ?>
                                                                    <li d-item="<?php echo e($category->products_count); ?>"
                            ...
                            <div class="row gutters-5 flex-wrap align-items-center">
                                <div class="col-lg col-10">
                                    ...
                                    <div class="fs-12 display-none" id="search_product_count"><span class="fw-bold"
                                            ...
                                            class="product-name-color "> <?php echo e(translate('Products Found')); ?></span></div>
                                    <div class="display-none fs-12 product-name-color" id="searching_product"><?php echo e(translate('Searching...')); ?>
    ...
    <script type="text/javascript">
        ...
        function filter_data(page = 1) {
            ...
            if (session_data_first_time) {
                const form_all_preorder_page = <?php echo json_encode($form_all_preorder_page, 15, 512) ?>;
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Murli_Devlopment\resources\views/frontend/product_listing.blade.php ENDPATH**/ ?>