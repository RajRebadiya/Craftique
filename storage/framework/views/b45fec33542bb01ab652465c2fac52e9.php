<?php if(count(get_featured_products()) > 0): ?>
    ...
    <section class="mb-2 mb-md-3 mt-2 mt-md-3">
        <div class="container">
            <div class="p-3 p-md-2rem rounded-2 <?php if(get_setting('featured_section_outline') == 1): ?> border <?php endif; ?>" style="background: <?php echo e($featured_bg != null ? $featured_bg : '#ffffff'); ?>; border-color: <?php echo e(get_setting('featured_section_outline_color')); ?> !important; padding-bottom: 0 !important;">
                <!-- Top Section -->
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Murli_Devlopment\resources\views/frontend/reclassic/partials/featured_products_section.blade.php ENDPATH**/ ?>