...
<li class="aiz-side-nav-item">
    <a href="#" class="aiz-side-nav-link">
        <div class="aiz-side-nav-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
                <path fill="#575b6a" d="M4 5h16l1 4v2h-1v9H4v-9H3V9l1-4zm2 6v7h4v-7H6zm6 0v7h6v-7h-6zM5.3 9h13.4l-.5-2H5.8l-.5 2z"/>
            </svg>
        </div>
    ...
    <ul class="aiz-side-nav-list level-2">
        <li class="aiz-side-nav-item">
            <a href="javascript:void(0);" class="aiz-side-nav-link">
                <span class="aiz-side-nav-text"><?php echo e(translate('Showcase Story')); ?></span>
                <span class="aiz-side-nav-arrow"></span>
            </a>
            <ul class="aiz-side-nav-list level-3">
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('showcase.history')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['showcase.history', 'showcase.history.edit'])); ?>">
                        <span class="aiz-side-nav-text"><?php echo e(translate('Add / Edit Story')); ?></span>
                    </a>
                </li>
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('showcase.history.list')); ?>" class="aiz-side-nav-link <?php echo e(request()->routeIs('showcase.history.list') ? 'active' : ''); ?>">
                        <span class="aiz-side-nav-text"><?php echo e(translate('Story List')); ?></span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="aiz-side-nav-item">
            <a href="javascript:void(0);" class="aiz-side-nav-link">
                <span class="aiz-side-nav-text"><?php echo e(translate('Showcase Collection')); ?></span>
                <span class="aiz-side-nav-arrow"></span>
            </a>
            <ul class="aiz-side-nav-list level-3">
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('showcase.collection')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['showcase.collection', 'showcase.collection.edit'])); ?>">
                        <span class="aiz-side-nav-text"><?php echo e(translate('Add / Edit Collection')); ?></span>
                    </a>
                </li>
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('showcase.collection.list')); ?>" class="aiz-side-nav-link <?php echo e(request()->routeIs('showcase.collection.list') ? 'active' : ''); ?>">
                        <span class="aiz-side-nav-text"><?php echo e(translate('Collection List')); ?></span>
                    </a>
                </li>
            </ul>
        </li>
       ...
       <li class="aiz-side-nav-item">
            <a href="javascript:void(0);" class="aiz-side-nav-link">
                <span class="aiz-side-nav-text"><?php echo e(translate('Showcase Storefront')); ?></span>
                <span class="aiz-side-nav-arrow"></span>
            </a>
            <ul class="aiz-side-nav-list level-3">
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('showcase.vitrin')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['showcase.vitrin', 'showcase.oru', 'showcase.vitrin.edit'])); ?>">
                        <span class="aiz-side-nav-text"><?php echo e(translate('Add / Edit Storefront')); ?></span>
                    </a>
                </li>
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('showcase.vitrin.list')); ?>" class="aiz-side-nav-link <?php echo e(request()->routeIs('showcase.vitrin.list') ? 'active' : ''); ?>">
                        <span class="aiz-side-nav-text"><?php echo e(translate('Storefront List')); ?></span>
                    </a>
                </li>
            </ul>
       </li>
       <li class="aiz-side-nav-item">
            <a href="javascript:void(0);" class="aiz-side-nav-link">
                <span class="aiz-side-nav-text"><?php echo e(translate('Showcase Launch')); ?></span>
                <span class="aiz-side-nav-arrow"></span>
            </a>
            <ul class="aiz-side-nav-list level-3">
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('showcase.launch')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['showcase.launch', 'showcase.launch.edit'])); ?>">
                        <span class="aiz-side-nav-text"><?php echo e(translate('Add / Edit Launch')); ?></span>
                    </a>
                </li>
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('showcase.launch.list')); ?>" class="aiz-side-nav-link <?php echo e(request()->routeIs('showcase.launch.list') ? 'active' : ''); ?>">
                        <span class="aiz-side-nav-text"><?php echo e(translate('Launch List')); ?></span>
                    </a>
                </li>
            </ul>
       </li>
       ...
       <li class="aiz-side-nav-item">
            <a href="<?php echo e(route('blog.index')); ?>"
                class="aiz-side-nav-link <?php echo e(areActiveRoutes(['blog.index', 'blog.create', 'blog.edit'])); ?>">
       ...
       <?php endif; ?>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                       ...
                       <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('pos_Order')): ?>
                        <li class="aiz-side-nav-item">
                            <a href="<?php echo e(route('pos.orders')); ?>" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text"><?php echo e(translate('POS Orders')); ?></span>
                            </a>
                        </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add_pos_products')): ?>
                        <li class="aiz-side-nav-item">
                            <a href="<?php echo e(route('admin.pos.products')); ?>" class="aiz-side-nav-link">
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                ...
                                <ul class="aiz-side-nav-list level-3">
                                    <li class="aiz-side-nav-item">
                                        <a href="<?php echo e(route('products.seller','all')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['products.seller.edit','digitalproducts.seller.edit'])); ?>">
                                            <span class="aiz-side-nav-text"><?php echo e(translate('All Products')); ?></span>
                                        </a>
                                    </li>
                                    <li class="aiz-side-nav-item">
                                        <a href="<?php echo e(route('products.seller','physical')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['products.seller.edit'])); ?>">
                                            <span class="aiz-side-nav-text"><?php echo e(translate('Physical Products')); ?></span>
                                        </a>
                                    </li>
                                    <li class="aiz-side-nav-item">
                                        <a href="<?php echo e(route('products.seller','digital')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['digitalproducts.seller.edit'])); ?>">
 ...
 <!-- Refund addon -->
                ...
                <!--Shipping System -->
                <?php if(addon_is_activated('shiprocket') || addon_is_activated('steadfast') || addon_is_activated('pathao') || addon_is_activated('redx')): ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['manage_shipping_system'])): ?>
                        <li class="aiz-side-nav-item">
                            ...
                            <?php endif; ?>
                            <?php if(addon_is_activated('redx')): ?> 
                                <ul class="aiz-side-nav-list level-2">
                                    <li class="aiz-side-nav-item">
                                        <a href="javascript:void(0);" class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text"><?php echo e(translate('Redx')); ?></span>
                                            <span class="aiz-side-nav-arrow"></span>
                                        </a>
                                        <ul class="aiz-side-nav-list level-3">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage_shipping_system')): ?>
                                                <li class="aiz-side-nav-item">
                                                    <a href="<?php echo e(route('redx_configuration')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['redx_configuration'])); ?>">
                                                        <span class="aiz-side-nav-text"><?php echo e(translate('Redx Configuration')); ?></span>
                                                    </a>
                                                </li>
                                            <?php endif; ?>
                                        </ul>
                                        <ul class="aiz-side-nav-list level-3">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage_redx_pickup_store')): ?>
                                                <li class="aiz-side-nav-item">
                                                    <a href="<?php echo e(route('redx_pickup.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['redx_pickup.index'])); ?>">
                                                        <span class="aiz-side-nav-text"><?php echo e(translate('Redx Pickup Store')); ?></span>
                                                    </a>
                                                </li>
                                            <?php endif; ?>
                                        </ul>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <?php if(addon_is_activated('uddoktapay')): ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('uddoktapay_configuration')): ?>
                                <li class="aiz-side-nav-item">
                                    <a href="<?php echo e(route('uddoktapay.configuration')); ?>" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text"><?php echo e(translate('Uddoktapay')); ?></span>
                                    </a>
                                </li>
                            <?php endif; ?>
                        <?php endif; ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['header_setup', 'footer_setup', 'view_all_website_pages', 'website_appearance', 'authentication_layout_settings', 'top_banner_setting', 'view_top_banner'])): ?>
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <?php endif; ?>
                            <!-- <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show_element')): ?>
                                <li class="aiz-side-nav-item">
                                    <a href="javascript:void(0);" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text"><?php echo e(translate('Element')); ?></span>
                                        <span class="aiz-side-nav-arrow"></span>
                                    </a>
                                    <ul class="aiz-side-nav-list level-3">
                                        <li class="aiz-side-nav-item">
                                            <a href="<?php echo e(route('elements.index')); ?>" class="aiz-side-nav-link">
                                                <span class="aiz-side-nav-text"><?php echo e(translate('All Elements')); ?></span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
...
<?php /**PATH C:\laragon\www\Murli_Devlopment\resources\views/backend/inc/admin_sidenav.blade.php ENDPATH**/ ?>