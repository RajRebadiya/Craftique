<?php if(count($preorder_products) > 0): ?>
    ...
    <section class="mb-2 mb-md-3 mt-2 mt-md-3">
        <div class="container">
            <div class="p-3 p-md-2rem rounded-2 <?php if(get_setting('featured_section_outline') == 1): ?> border <?php endif; ?>" style="background: <?php echo e($featured_bg != null ? $featured_bg : '#ffffff'); ?>; border-color: <?php echo e(get_setting('featured_section_outline_color')); ?> !important; padding-bottom: 0 !important;" id="section_preorder_featured_div">
                <!-- Top Section -->
                <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                    <!-- Title -->
                    <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0">
                        <span class=""><?php echo e(translate('Preorder Featured Products')); ?></span>
                    </h3>
                    <!-- Links -->
                    <div class="d-flex">
...
<?php endif; ?><?php /**PATH C:\laragon\www\Murli_Devlopment\resources\views/frontend/reclassic/partials/preorder_products_section.blade.php ENDPATH**/ ?>