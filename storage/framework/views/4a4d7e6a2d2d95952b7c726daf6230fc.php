...
<?php $__env->startSection('content'); ?>
                            ...
                            <div class="aiz-carousel overflow-hidden rounded-2" data-autoplay="true" data-infinite="true">
                                ...
                                <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="carousel-box">
                                        <a class="d-block" href="<?php echo e(isset(json_decode($home_slider_links, true)[$key]) ? json_decode($home_slider_links, true)[$key] : ''); ?>">
                                            <img
                                                class="d-block mw-100 img-fit h-180px h-md-320px <?php if(count($featured_categories) == 0): ?> h-lg-530px <?php else: ?> h-lg-350px <?php endif; ?>"
                                    ...
                                    <div class="carousel-box">
                                        <div class="d-flex flex-column align-items-center overflow-hidden" style="width: 110px; height: 155px;border-radius: 8px;background: #f5f6f7; box-shadow: 0px 0px 25px -15px rgba(171,169,171,1);">
                                            <div class="overflow-hidden hov-scale-img" style="width: 110px; height:100px; min-height:100px;">
                                                <a class="d-block h-100" href="<?php echo e(route('products.category', $category->slug)); ?>">
                    ...
                    <div class="col-12 col-lg-auto mt-4">
                        <div class="todays_deal bg-white rounded-2 overflow-hidden">
                            <div class="bg-soft-primary p-3 d-flex align-items-center justify-content-center">
                                ...
                                <span class="badge badge-primary badge-inline rounded-1 fs-11"><?php echo e(translate('Hot')); ?></span>
                            </div>
    ...
    <?php if($flash_deal != null): ?>
        <section class="mb-2 mb-md-3 mt-2 mt-md-3" id="flash_deal">
            <div class="container">
                <div class="rounded-2 overflow-hidden p-3 p-md-2rem <?php if(get_setting('flash_deal_section_outline') == 1): ?> border <?php endif; ?>" style="background: <?php echo e($flash_deal_bg != null ? $flash_deal_bg : '#fff9ed'); ?>; border-color: <?php echo e(get_setting('flash_deal_section_outline_color')); ?> !important;">
                    <!-- Top Section -->
                    <div class="d-flex flex-wrap align-items-baseline justify-content-center justify-content-sm-between mb-2 mb-md-3 position-relative">
                        <div class="d-flex flex-wrap align-items-center">
                            ...
                            <!-- Countdown -->
                            <div class="aiz-count-down align-items-center ml-2 mb-2 mb-lg-0" data-date="<?php echo e(date('Y/m/d H:i:s', $flash_deal->end_date)); ?>"></div>
                        </div>
                        ...
                        <div>
                            <div class="text-dark d-flex align-items-center mb-0">
                                <a href="<?php echo e(route('flash-deals')); ?>"
                                    class="fs-10 fs-md-12 fw-700 has-transition text-reset opacity-60 hov-opacity-100 hov-text-primary animate-underline-primary mr-3"><?php echo e(translate('View All Flash Sale')); ?></a>
                                <span class=" border-left border-soft-light border-width-2 pl-3">
                                    <a href="<?php echo e(route('flash-deal-details', $flash_deal->slug)); ?>"
                                        class="fs-10 fs-md-12 fw-700 has-transition text-reset opacity-60 hov-opacity-100 hov-text-primary animate-underline-primary"><?php echo e(translate('View All Products from This Flash Sale')); ?></a>
                                </span>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <a href="<?php echo e($product_url); ?>"
                                                    ...
                                                    <h3 class="fw-400 fs-13 text-truncate-2 lh-1-4 mb-0 h-40px text-center pt-1 px-1 mt-1">
                                                        <a href="<?php echo e($product_url); ?>" class="d-block text-reset hov-text-primary"
                                                            title="<?php echo e($flash_deal_product->product->getTranslation('name')); ?>"><?php echo e($flash_deal_product->product->getTranslation('name')); ?></a>
                                                    </h3>
                                                    <!-- Price -->
                                                    <h4 class="fs-14 d-flex justify-content-center mt-3">
                                                        <?php if($flash_deal_product->auction_product == 0): ?>
                                                            <!-- Previous price -->
                                                            <?php if(home_base_price($flash_deal_product->product) != home_discounted_base_price($flash_deal_product->product)): ?>
                                                                <span class="disc-amount has-transition">
                                                                    <del class="fw-400 text-secondary mr-1"><?php echo e(home_base_price($flash_deal_product->product)); ?></del>
                                                                </span>
                                                            <?php endif; ?>
                                                            <!-- price -->
                                                            <span class="fw-700 text-primary"><?php echo e(home_discounted_base_price($flash_deal_product->product)); ?></span>
                                                        <?php endif; ?>
                                                    </h4>
                                                </a>
                                            </div>
    ...
    <!-- Featured Products -->
<?php echo $__env->make('frontend.reclassic.partials.showcase_home_section', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php if(addon_is_activated('preorder')): ?>
        <!-- Banner Section 2 -->
        <?php $homepreorder_banner_1Images = get_setting('home_preorder_banner_1_images', null, $lang);   ?>
        <?php if($homepreorder_banner_1Images != null): ?>
            <div class="mb-2 mb-md-3 mt-2 mt-md-3">
                <div class="container">
                    <?php
                    ...
                    <div class="rounded-2 overflow-hidden">
                        ...
                        <?php $__currentLoopData = $banner_2_imags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="carousel-box overflow-hidden hov-scale-img">
                                <a href="<?php echo e(isset(json_decode($home_preorder_banner_1_links, true)[$key]) ? json_decode($home_preorder_banner_1_links, true)[$key] : ''); ?>"
                                    class="d-block text-reset rounded-2 overflow-hidden">
                                    <img src="<?php echo e(static_asset('assets/img/placeholder-rect.jpg')); ?>"
                                        data-src="<?php echo e(uploaded_asset($value)); ?>" alt="<?php echo e(env('APP_NAME')); ?> promo"
                                        class="img-fluid lazyload w-100 has-transition"
    ...
    <?php if(get_setting('coupon_system') == 1): ?>
        <div class="" style="background-color: <?php echo e(get_setting('cupon_background_color', '#fff9ed')); ?>">
            <div class="container">
                <div class="position-relative py-5">
                    <div class="text-center text-xl-left position-relative z-5">
                        <div class="d-lg-flex">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="109.602" height="93.34" viewBox="0 0 109.602 93.34">
                                    <defs>
                                      <clipPath id="clip-path">
                                        <path id="Union_10" data-name="Union 10" d="M12263,13778v-15h64v-41h12v56Z" transform="translate(-11966 -8442.865)" fill="none" stroke="var(--<?php echo e(get_setting('cupon_text_color')); ?>)" stroke-width="2"/>
                                      </clipPath>
                                    </defs>
                                    <g id="Group_25375" data-name="Group 25375" transform="translate(-274.201 -5254.611)">
                                      ...
                                      <g id="Group_24321" data-name="Group 24321" transform="translate(-3514.477 1653.317) rotate(-45)">
                                        ...
                                        <g id="Group_24325" data-name="Group 24325">
                                          <rect id="Rectangle_18578" data-name="Rectangle 18578" width="8" height="2" transform="translate(120 5287)" fill="var(--<?php echo e(get_setting('cupon_text_color')); ?>)"/>
                                          <rect id="Rectangle_18579" data-name="Rectangle 18579" width="8" height="2" transform="translate(132 5287)" fill="var(--<?php echo e(get_setting('cupon_text_color')); ?>)"/>
                                          <rect id="Rectangle_18581" data-name="Rectangle 18581" width="8" height="2" transform="translate(144 5287)" fill="var(--<?php echo e(get_setting('cupon_text_color')); ?>)"/>
                                          <rect id="Rectangle_18580" data-name="Rectangle 18580" width="8" height="2" transform="translate(108 5287)" fill="var(--<?php echo e(get_setting('cupon_text_color')); ?>)"/>
                                        </g>
                                      </g>
                                    </g>
                                </svg>
                            ...
                            <div class="ml-lg-3">
                                <h5 class="fs-36 fw-700 text-<?php echo e(get_setting('cupon_text_color')); ?> mb-3"><?php echo e(translate(get_setting('cupon_title'))); ?></h5>
                                <h5 class="fs-20 fw-400 text-<?php echo e(get_setting('cupon_text_color')); ?>"><?php echo e(translate(get_setting('cupon_subtitle'))); ?></h5>
                                <div class="mt-5 pt-5">
                                    <a href="<?php echo e(route('coupons.all')); ?>" class="btn btn-secondary rounded-2 fs-16 px-4"
                                        style="box-shadow: 0px 20px 30px rgba(0, 0, 0, 0.16);"><?php echo e(translate('View All Coupons')); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="position-absolute right-0 bottom-0 h-100">
                        <img class="img-fit h-100" src="<?php echo e(uploaded_asset(get_setting('coupon_background_image', null, $lang))); ?>"
                            onerror="this.onerror=null;this.src='<?php echo e(static_asset('assets/img/coupon.svg')); ?>';"
                            alt="<?php echo e(env('APP_NAME')); ?> promo">
                    </div>
                </div>
            </div>
    ...
    <?php if(addon_is_activated('preorder')): ?>
        ...
        <?php echo $__env->make('preorder.frontend.home_page.newest_preorder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
    ...
    <?php if(get_setting('classified_product') == 1): ?>
        ...
        <?php if(count($classified_products) > 0): ?>
            <section class="mb-2 mb-md-3 mt-2rem">
                <div class="container">
                    <div class="p-3 p-md-2rem rounded-2 overflow-hidden <?php if(get_setting('classified_section_outline') == 1): ?> border <?php endif; ?>"
                        style="background: <?php echo e($classified_section_bg != null ? $classified_section_bg : '#fff9ed'); ?>; border-color: <?php echo e(get_setting('classified_section_outline_color')); ?> !important;">
                        <!-- Top Section -->
    ...
    <?php if(get_setting('vendor_system_activation') == 1): ?>
        ...
        <section class="mb-2 mb-md-3 mt-2 mt-md-3">
            <div class="container">
                <div class="p-3 p-md-2rem rounded-2 <?php if(get_setting('sellers_section_outline') == 1): ?> border <?php endif; ?>"
                    style="background: <?php echo e($sellers_section_bg != null ? $sellers_section_bg : '#fff9ed'); ?>; border-color: <?php echo e(get_setting('sellers_section_outline_color')); ?> !important; padding-bottom: 1rem !important;">
                    <!-- Top Section -->
                    <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                        <!-- Title -->
                        <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0">
                        ...
                        <div class="col-xl-4 col-md-6 py-3 py-md-4 has-transition hov-shadow-out z-1">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ml-2 ml-lg-4">
                                    ...
                                    <!-- Visit Button -->
                                    <a href="<?php echo e(route('shop.visit', $seller->slug)); ?>" class="visite-btn">
                                        <span class="button-text"><?php echo e(ucfirst(translate('Visit Store'))); ?></span>
    ...
    <?php if(get_setting('top_brands') != null): ?>
        ...
        <section class="mb-2 mb-md-3 mt-2 mt-md-3 pb-2 pb-md-3">
            <div class="container">
                <div class="p-3 p-md-2rem rounded-2 <?php if(get_setting('brands_section_outline') == 1): ?> border <?php endif; ?>"
                    style="background: <?php echo e($brands_section_bg != null ? $brands_section_bg : '#f0f2f5'); ?>; border-color: <?php echo e(get_setting('brands_section_outline_color')); ?> !important; padding-bottom: 1rem !important;">
                    <!-- Top Section -->
                    <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                        <!-- Title -->
                    ...
                    <div class="row gutters-16">
                        ...
                        <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-xl-3 col-lg-4 col-6 my-3">
                                <a href="<?php echo e(route('products.brand', $brand->slug)); ?>" class="d-block has-transition hov-shadow-out z-1 hov-scale-img rounded-2 overflow-hidden">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Murli_Devlopment\resources\views/frontend/reclassic/index.blade.php ENDPATH**/ ?>