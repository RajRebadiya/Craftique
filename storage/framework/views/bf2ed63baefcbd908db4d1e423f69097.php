<?php $__env->startSection('panel_content'); ?>
    ...
    <div class="aiz-titlebar mt-2 mb-4">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="h3 mb-0"><?php echo e($page_title ?? translate('Storefront Form')); ?></h1>
                <p class="text-muted mb-0 mt-1"><?php echo e(translate('Seller Showcase / Storefront')); ?></p>
            </div>
            <div class="col-md-4 text-md-right mt-3 mt-md-0">
                <a href="<?php echo e(route('seller.showcase.vitrin.index')); ?>" class="btn btn-soft-secondary">
                    <?php echo e(translate('Back to Storefronts')); ?>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body p-4">
            ...
            <ul class="mb-0 pl-3 text-muted">
                ...
                <li><?php echo e(translate('Cover image is optional and can be used as preview / fallback.')); ?></li>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-header">
                        <h5 class="mb-0 h6"><?php echo e(translate('Storefront Cover / Main Visual')); ?></h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row mb-0">
                            <label class="col-lg-2 col-form-label"><?php echo e(translate('Cover Image')); ?></label>
                            <div class="col-lg-10">
                ...
                <div class="text-right mb-4">
                    <button type="submit" class="btn btn-primary">
                        <?php echo e($isEdit ? translate('Update Storefront') : translate('Save Storefront')); ?>
            ...
            <div class="col-lg-4">
                ...
                <?php echo $__env->make('seller.showcase._products', [
                    'products' => $products,
...
<?php echo $__env->make('seller.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Murli_Devlopment\resources\views/seller/showcase/vitrin/form.blade.php ENDPATH**/ ?>