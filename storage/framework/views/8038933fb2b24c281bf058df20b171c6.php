...
<?php $__env->startSection('panel_content'); ?>
                    ...
                    <div class="row align-items-center">
                     ...
                     <div class="d-flex justify-content-between mt-3">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <p class="fs-12 text-light my-1 ml-1"><?php echo e(translate('Add New Product')); ?></p>
                        </div>
                        </a>
                     </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mt-3">
                        <div class="d-flex align-items-center pt-1">
                            ...
                            <p class="fs-12 text-light my-1 ml-1"><?php echo e(translate('Followers').' '.$authUser->shop?->followers()->count()); ?></p>
                        </div>
                        <div class="d-flex align-items-center">
                            ...
                            <p class="fs-12 text-light my-1 ml-1"><?php echo e(translate('Custom Followers').' '.$authUser->shop?->custom_followers); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mt-3">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <p class="fs-12 text-light my-1 ml-1"><?php echo e(translate('View All Order')); ?></p>
                        </div>
                        </a>
                     </div>
                </div>
            ...
            <div class="card shadow-none mb-4 bg-primary ">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mt-3">
                        <a href="<?php echo e(route('seller.orders.index')); ?>">
                        <div class="d-flex align-items-center">
                            <p class="fs-12 text-light my-1 ml-1"> <?php echo e(translate('Last Month')); ?>: <?php echo e(single_price($previous_month_sold_amount)); ?></p>
                        </div>
                        </a>
                     </div>
                </div>
    ...
    <div class="row">
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
            ...
            <div class="card shadow-none bg-soft-primary mb-0">
                <div class="card-body">
                    ...
                    <p class="mb-1"><?php echo e(translate('Your Sold Amount (Current month)')); ?></p>
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title ">
                            <h6 class="mb-0 text-primary fs-16 fw-600"><?php echo e(translate('Purchased Package')); ?></h6>
                        </div>
            ...
            <?php endif; ?>
            <div
                class="card mb-0 <?php if(addon_is_activated('seller_subscription')): ?> px-4 py-4 <?php else: ?> p-5 h-100 <?php endif; ?> d-flex align-items-center justify-content-center">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-primary">
                <h6 class="mb-0 fs-16 fw-600"><?php echo e(translate('Top 12 Products')); ?></h6>
            </div>
...
<?php echo $__env->make('seller.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Murli_Devlopment\resources\views/seller/dashboard.blade.php ENDPATH**/ ?>