<?php $__env->startSection('panel_content'); ?>
    <div class="aiz-titlebar mt-2 mb-4">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="h3 mb-0"><?php echo e(translate('Launches')); ?></h1>
                <p class="text-muted mb-0 mt-1">
                    <?php echo e(translate('Manage your seller Launch posts for the public Showcase feed.')); ?>

                </p>
            </div>
            <div class="col-md-4 text-md-right mt-3 mt-md-0">
                <a href="<?php echo e(route('seller.showcase.launch.create')); ?>" class="btn btn-primary">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header">
            <h5 class="mb-0 h6"><?php echo e(translate('Launch List')); ?></h5>
        </div>
        ...
        <div class="card-body">
                            ...
                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a href="<?php echo e(route('seller.showcase.launch.edit', $item->id)); ?>"
                                           class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                           title="<?php echo e(translate('Edit')); ?>">
                                            <i class="las la-edit"></i>
                                        </a>

                                        <form action="<?php echo e(url('/seller/showcase/launch/' . $item->id . '/toggle-status')); ?>"
                                              method="POST"
                                        ...
                                        <form action="<?php echo e(url('/seller/showcase/launch/' . $item->id)); ?>"
                                              method="POST"
                                              class="d-inline-block"
                                              onsubmit="return confirm('<?php echo e(translate('Delete this Launch?')); ?>')">
                                            <?php echo csrf_field(); ?>
            ...
            <?php else: ?>
                <div class="text-center py-5">
                    <h5 class="mb-2"><?php echo e(translate('No Launches yet')); ?></h5>
                    <p class="text-muted mb-4">
                        <?php echo e(translate('Create your first Launch to start appearing in the Showcase feed.')); ?>
...
<?php echo $__env->make('seller.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Murli_Devlopment\resources\views/seller/showcase/launch/index.blade.php ENDPATH**/ ?>