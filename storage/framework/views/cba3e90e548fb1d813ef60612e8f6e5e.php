<div class="col-sm-12 col-lg-6">
    ...
    <?php else: ?>
            ...
            <div class="bg-light overflow-hidden px-20px py-20px rounded-2">
                <?php if($detailedProduct->digital == 0): ?>
                    <div class="d-flex align-items-center justify-content-between mb-md-0">
                        ...
                        <a href="<?php echo e(uploaded_asset($detailedProduct->pdf)); ?>" target="_blank" class="fs-14 fw-400 text-blue cursor-pointer"> <i class="las la-download mr-1"></i>
                            <?php echo e(translate('Download product specifation')); ?>
            ...
            <div class="row no-gutters mb-3">
                <div class="col-12 col-sm-12 mt-3">
                    <div class="product-quantity d-flex align-items-center">
                        <a type="button" target="_blank" class="text-white text-center border-0 rounded-1 fs-14 fw-bold bg-black hov-opacity-70 has-transition py-20px px-20px d-block w-100 mb-2 mb-md-0 mr-0 mr-md-2" href="<?php echo e($detailedProduct->external_link); ?>">
        ...
        <?php endif; ?>
    <?php endif; ?>
</div><?php /**PATH C:\laragon\www\Murli_Devlopment\resources\views/frontend/product_details/details.blade.php ENDPATH**/ ?>