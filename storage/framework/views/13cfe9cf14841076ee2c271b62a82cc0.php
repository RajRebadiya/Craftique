        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between mb-2">
            ...
            <div class="row">
                ...
                <div class="w-100 w-md-auto col-12 col-md-5 mb-2 md-mb-0">
                    <a href="javascript:void(0)" onclick="reviewByImages()" class="btn review-sort-by-images hover-border-dark mr-2 rounded-1 border border-1 border-gray-300 bg-white cursor-pointer"> <?php echo e(translate('Sort by Image')); ?> </a>
                </div>
...
<?php /**PATH C:\laragon\www\Murli_Devlopment\resources\views/frontend/product_details/review_section.blade.php ENDPATH**/ ?>