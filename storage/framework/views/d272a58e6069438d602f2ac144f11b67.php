<div class="card">
    <div class="card-header">
        <h5 class="mb-0"><?php echo e(translate('Products')); ?></h5>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="form-group mb-3">
            <label class="mb-1 text-muted"><?php echo e(translate('Category')); ?></label>
        ...
        <div class="form-group mb-3">
            <label class="mb-1 text-muted"><?php echo e(translate('Subcategory')); ?></label>
        ...
        <div class="form-group mb-3">
            <label class="aiz-checkbox">
                ...
                <span class="text-muted"><?php echo e(translate('Auto-select all products from selected category/subcategory')); ?></span>
                <span class="aiz-square-check"></span>
            </label>
        </div>

        <div class="form-group mb-3">
            <input type="text" class="form-control" id="showcaseProductSearch" placeholder="<?php echo e(translate('Search products...')); ?>">
        </div>

        <div id="showcaseProductList" style="max-height: 520px; overflow-y: auto;">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <p class="mb-0 text-muted"><?php echo e(translate('No products found.')); ?></p>
            <?php endif; ?>
        </div>
        <p class="mt-2 mb-0 text-muted small" id="showcaseProductHint">
            <?php echo e(translate('Products are loaded by default. Use category, subcategory, or search to narrow them down.')); ?>
...
<?php /**PATH C:\laragon\www\Murli_Devlopment\resources\views/seller/showcase/_products.blade.php ENDPATH**/ ?>