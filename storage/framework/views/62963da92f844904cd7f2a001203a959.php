			...
			<div class="aiz-main-content">
				...
				<div class="bg-white text-center py-3 px-15px px-lg-25px mt-auto border-sm-top ">
                    ...
                    <div class="d-flex justify-content-center flex-wrap">
                        <a href="<?php echo e(route('home')); ?>/seller-legal-notice" target="_blank" class="btn btn-link p-0 text-decoration-none mr-3 fw-700 fs-12 hov-text-info">
                            <?php echo e(translate('Legal Notice')); ?>

                        </a>
                        <a href="<?php echo e(route('home')); ?>/seller-withdrawal-policy" target="_blank" class="btn btn-link p-0 text-decoration-none mr-3 fw-700 fs-12 hov-text-info">
                            <?php echo e(translate('Right of Withdrawal')); ?>

                        </a>
                        <a href="<?php echo e(route('home')); ?>/seller-terms-and-conditions" target="_blank" class="btn btn-link p-0 text-decoration-none mr-3 fw-700 fs-12 hov-text-info">
                            <?php echo e(translate('Terms & Conditions')); ?>

                        </a>
                        <a href="<?php echo e(route('home')); ?>/seller-policy" target="_blank" class="btn btn-link p-0 text-decoration-none mr-3 fw-700 fs-12 hov-text-info">
                            <?php echo e(translate('Seller Privacy Policy')); ?>

                        </a>
                    </div>

                    <p class="mb-0 mt-2 fs-11">
                        &copy; <?php echo e(get_setting('site_name')); ?> v<?php echo e(get_setting('current_version')); ?>
...
<?php /**PATH C:\laragon\www\Murli_Devlopment\resources\views/seller/layouts/app.blade.php ENDPATH**/ ?>