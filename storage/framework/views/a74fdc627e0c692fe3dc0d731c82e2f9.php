<?php if(count($newest_products) > 0): ?>
    ...
    <section class="mb-2 mb-md-3 mt-2 mt-md-3">
        <div class="container">
            <div class="p-3 p-md-2rem rounded-2 <?php if(get_setting('new_products_section_outline') == 1): ?> border <?php endif; ?>" style="background: <?php echo e($new_products_section_bg != null ? $new_products_section_bg : '#ffffff'); ?>; border-color: <?php echo e(get_setting('new_products_section_outline_color')); ?> !important; padding-bottom: 0 !important;">
                <!-- Top Section -->
                ...
                <div class="px-sm-3">
                    <div class="aiz-carousel sm-gutters-16 arrow-none" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='false'>
                        <?php $__currentLoopData = $newest_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Murli_Devlopment\resources\views/frontend/reclassic/partials/newest_products_section.blade.php ENDPATH**/ ?>