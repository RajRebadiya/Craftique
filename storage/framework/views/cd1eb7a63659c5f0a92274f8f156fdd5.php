<h5 class="fs-16 fw-bold text-dark"><?php echo e(translate('Other Questions')); ?></h5>
<div class="d-flex flex-column pt-20px other-question">
    ...
    <div class="d-flex">
        <p class="m-0 fs-14 text-gray mr-2"><?php echo e(translate('No queries have been asked to the seller yet')); ?></p>
        <span>
...
</div><?php /**PATH C:\laragon\www\Murli_Devlopment\resources\views/frontend/partials/product_query_pagination.blade.php ENDPATH**/ ?>