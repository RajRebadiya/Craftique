...
class BlogController extends Controller
{
    ...
    public function create()
    {
        ...
        $products = \DB::table('products')
            ...
            ->limit(200)
            ->get();
        return view('backend.blog_system.blog.create', compact('blog_categories', 'products'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.blog_system.blog.edit', compact('blog', 'blog_categories', 'products'));
    }
    ...
    public function blog_details($slug)
    {
        ...
        $recent_blogs = Blog::where('status', 1)->orderBy('created_at', 'desc')->limit(9)->get();
        $productIds = is_array($blog?->product_ids) ? $blog->product_ids : [];
        $products = \App\Models\Product::query()
            ->whereIn('id', $productIds)
            ->get();
        return view("frontend.blog.details", compact('blog', 'recent_blogs', 'products'));
    }
