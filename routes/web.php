...
use App\Http\Controllers\ShowcasePreviewController;
...
Route::middleware(['auth'])->group(function () {
    Route::post('/showcase/preview/products', [ShowcasePreviewController::class, 'products'])->name('showcase.preview.products');
});
...
Route::controller(\App\Http\Controllers\FrontendShowcaseController::class)->group(function () {
    ...
    Route::get('/showcase/launch', 'launch')->name('frontend.showcase.launch');
    Route::get('/showcase/post/{id}/{slug?}', 'show')->name('frontend.showcase.post');
});
