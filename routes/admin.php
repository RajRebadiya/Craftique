...
// Showcase
Route::controller(\App\Http\Controllers\ShowcaseController::class)->group(function () {
    // History
    Route::get('/showcase/history', 'history')->name('showcase.history');
    Route::post('/showcase/history/store', 'storeHistory')->name('showcase.history.store');
    Route::get('/showcase/history/list', 'historyList')->name('showcase.history.list');
    Route::get('/showcase/history/edit/{id}', 'historyEdit')->name('showcase.history.edit');
    Route::get('/showcase/history/delete/{id}', 'historyDelete')->name('showcase.history.delete');
    Route::get('/showcase/history/status/{id}', 'historyToggleStatus')->name('showcase.history.status');
	
// Collection
    Route::get('/showcase/collection', 'collection')->name('showcase.collection');
    Route::post('/showcase/collection/store', 'storeCollection')->name('showcase.collection.store');
    Route::get('/showcase/collection/list', 'collectionList')->name('showcase.collection.list');
    Route::get('/showcase/collection/edit/{id}', 'collectionEdit')->name('showcase.collection.edit');
    Route::get('/showcase/collection/delete/{id}', 'collectionDelete')->name('showcase.collection.delete');
    Route::get('/showcase/collection/status/{id}', 'collectionToggleStatus')->name('showcase.collection.status');

    // Vitrin
    Route::get('/showcase/vitrin', 'vitrin')->name('showcase.vitrin');
    Route::post('/showcase/vitrin/store', 'storeVitrin')->name('showcase.vitrin.store');
    Route::get('/showcase/vitrin/list', 'vitrinList')->name('showcase.vitrin.list');
    Route::get('/showcase/vitrin/edit/{id}', 'vitrinEdit')->name('showcase.vitrin.edit');
    Route::get('/showcase/vitrin/delete/{id}', 'vitrinDelete')->name('showcase.vitrin.delete');
    Route::get('/showcase/vitrin/status/{id}', 'vitrinToggleStatus')->name('showcase.vitrin.status');

    Route::get('/showcase/launch', 'launch')->name('showcase.launch');
    Route::post('/showcase/launch/store', 'storeLaunch')->name('showcase.launch.store');
    Route::get('/showcase/launch/list', 'launchList')->name('showcase.launch.list');
    Route::get('/showcase/launch/edit/{id}', 'launchEdit')->name('showcase.launch.edit');
    Route::get('/showcase/launch/delete/{id}', 'launchDelete')->name('showcase.launch.delete');
    Route::get('/showcase/launch/status/{id}', 'launchToggleStatus')->name('showcase.launch.status');

    // Temporary backward compatibility for old Oru routes
    Route::get('/showcase/oru', 'oru')->name('showcase.oru');
    Route::post('/showcase/oru/store', 'storeOru')->name('showcase.oru.store');
});
