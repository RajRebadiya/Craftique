...
Route::group(['namespace' => 'App\Http\Controllers\Seller', 'prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user', 'prevent-back-history', 'block_external_urls'], 'as' => 'seller.'], function () {
    Route::controller(DashboardController::class)->group(function () {
        Route::get('/dashboard', 'index')->name('dashboard');
    });

	Route::controller(\App\Http\Controllers\Seller\ShowcaseHistoryController::class)->group(function () {
    Route::get('/showcase/history', 'index')->name('showcase.history.index');
    Route::get('/showcase/history/create', 'create')->name('showcase.history.create');
    Route::post('/showcase/history/store', 'store')->name('showcase.history.store');
    Route::get('/showcase/history/{id}/edit', 'edit')->name('showcase.history.edit');
    Route::post('/showcase/history/update/{id}', 'update')->name('showcase.history.update');
    Route::get('/showcase/history/status/{id}', 'toggleStatus')->name('showcase.history.status');
    Route::get('/showcase/history/delete/{id}', 'destroy')->name('showcase.history.delete');
});

	Route::controller(\App\Http\Controllers\Seller\ShowcaseCollectionController::class)->group(function () {
    Route::get('/showcase/collection', 'index')->name('showcase.collection.index');
    Route::get('/showcase/collection/create', 'create')->name('showcase.collection.create');
    Route::post('/showcase/collection/store', 'store')->name('showcase.collection.store');
    Route::get('/showcase/collection/{id}/edit', 'edit')->name('showcase.collection.edit');
    Route::post('/showcase/collection/update/{id}', 'update')->name('showcase.collection.update');
    Route::get('/showcase/collection/status/{id}', 'toggleStatus')->name('showcase.collection.status');
    Route::get('/showcase/collection/delete/{id}', 'destroy')->name('showcase.collection.delete');
});
	
	Route::controller(\App\Http\Controllers\Seller\ShowcaseVitrinController::class)->group(function () {
    Route::get('/showcase/vitrin', 'index')->name('showcase.vitrin.index');
    Route::get('/showcase/vitrin/create', 'create')->name('showcase.vitrin.create');
    Route::post('/showcase/vitrin/store', 'store')->name('showcase.vitrin.store');
    Route::get('/showcase/vitrin/{id}/edit', 'edit')->name('showcase.vitrin.edit');
    Route::post('/showcase/vitrin/update/{id}', 'update')->name('showcase.vitrin.update');
    Route::get('/showcase/vitrin/status/{id}', 'toggleStatus')->name('showcase.vitrin.status');
    Route::get('/showcase/vitrin/delete/{id}', 'destroy')->name('showcase.vitrin.delete');
});

	Route::controller(\App\Http\Controllers\Seller\ShowcaseLaunchController::class)->group(function () {
    Route::get('/showcase/launch', 'index')->name('showcase.launch.index');
    Route::get('/showcase/launch/create', 'create')->name('showcase.launch.create');
    Route::post('/showcase/launch/store', 'store')->name('showcase.launch.store');
    Route::get('/showcase/launch/{id}/edit', 'edit')->name('showcase.launch.edit');
    Route::post('/showcase/launch/update/{id}', 'update')->name('showcase.launch.update');
    Route::get('/showcase/launch/status/{id}', 'toggleStatus')->name('showcase.launch.status');
    Route::get('/showcase/launch/delete/{id}', 'destroy')->name('showcase.launch.delete');
});
	
	Route::controller(\App\Http\Controllers\Seller\ShowcaseCenterController::class)->group(function () {
    Route::get('/showcase', 'index')->name('showcase.index');
});

    Route::controller(\App\Http\Controllers\Seller\BlogController::class)->group(function () {
        Route::get('/blog', 'index')->name('blog.index');
        Route::get('/blog/create', 'create')->name('blog.create');
        Route::post('/blog/store', 'store')->name('blog.store');
        Route::get('/blog/{id}/edit', 'edit')->name('blog.edit');
        Route::patch('/blog/{id}', 'update')->name('blog.update');
        Route::get('/blog/destroy/{id}', 'destroy')->name('blog.destroy');
    });

    Route::controller(\App\Http\Controllers\Seller\BlogCategoryController::class)->group(function () {
