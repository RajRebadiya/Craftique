...
<li class="aiz-side-nav-item">
    <a href="#" class="aiz-side-nav-link">
        ...
        <span class="aiz-side-nav-text">{{ translate('Showcase') }}</span>
    ...
    <ul class="aiz-side-nav-list level-2">
        <li class="aiz-side-nav-item">
            <a href="javascript:void(0);" class="aiz-side-nav-link">
                <span class="aiz-side-nav-text">{{ translate('Showcase Story') }}</span>
                <span class="aiz-side-nav-arrow"></span>
            </a>
            <ul class="aiz-side-nav-list level-3">
                <li class="aiz-side-nav-item">
                    <a href="{{ route('showcase.history') }}" class="aiz-side-nav-link {{ areActiveRoutes(['showcase.history', 'showcase.history.edit']) }}">
                        <span class="aiz-side-nav-text">{{ translate('Add / Edit Story') }}</span>
                    </a>
                </li>
                <li class="aiz-side-nav-item">
                    <a href="{{ route('showcase.history.list') }}" class="aiz-side-nav-link {{ request()->routeIs('showcase.history.list') ? 'active' : '' }}">
                        <span class="aiz-side-nav-text">{{ translate('Story List') }}</span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="aiz-side-nav-item">
            <a href="javascript:void(0);" class="aiz-side-nav-link">
                <span class="aiz-side-nav-text">{{ translate('Showcase Collection') }}</span>
                <span class="aiz-side-nav-arrow"></span>
            </a>
            <ul class="aiz-side-nav-list level-3">
                <li class="aiz-side-nav-item">
                    <a href="{{ route('showcase.collection') }}" class="aiz-side-nav-link {{ areActiveRoutes(['showcase.collection', 'showcase.collection.edit']) }}">
                        <span class="aiz-side-nav-text">{{ translate('Add / Edit Collection') }}</span>
                    </a>
                </li>
                <li class="aiz-side-nav-item">
                    <a href="{{ route('showcase.collection.list') }}" class="aiz-side-nav-link {{ request()->routeIs('showcase.collection.list') ? 'active' : '' }}">
                        <span class="aiz-side-nav-text">{{ translate('Collection List') }}</span>
                    </a>
                </li>
            </ul>
        </li>
       ...
       <li class="aiz-side-nav-item">
            <a href="javascript:void(0);" class="aiz-side-nav-link">
                <span class="aiz-side-nav-text">{{ translate('Showcase Storefront') }}</span>
                <span class="aiz-side-nav-arrow"></span>
            </a>
            <ul class="aiz-side-nav-list level-3">
                <li class="aiz-side-nav-item">
                    <a href="{{ route('showcase.vitrin') }}" class="aiz-side-nav-link {{ areActiveRoutes(['showcase.vitrin', 'showcase.oru', 'showcase.vitrin.edit']) }}">
                        <span class="aiz-side-nav-text">{{ translate('Add / Edit Storefront') }}</span>
                    </a>
                </li>
                <li class="aiz-side-nav-item">
                    <a href="{{ route('showcase.vitrin.list') }}" class="aiz-side-nav-link {{ request()->routeIs('showcase.vitrin.list') ? 'active' : '' }}">
                        <span class="aiz-side-nav-text">{{ translate('Storefront List') }}</span>
                    </a>
                </li>
            </ul>
       </li>
       <li class="aiz-side-nav-item">
            <a href="javascript:void(0);" class="aiz-side-nav-link">
                <span class="aiz-side-nav-text">{{ translate('Showcase Launch') }}</span>
                <span class="aiz-side-nav-arrow"></span>
            </a>
            <ul class="aiz-side-nav-list level-3">
                <li class="aiz-side-nav-item">
                    <a href="{{ route('showcase.launch') }}" class="aiz-side-nav-link {{ areActiveRoutes(['showcase.launch', 'showcase.launch.edit']) }}">
                        <span class="aiz-side-nav-text">{{ translate('Add / Edit Launch') }}</span>
                    </a>
                </li>
                <li class="aiz-side-nav-item">
                    <a href="{{ route('showcase.launch.list') }}" class="aiz-side-nav-link {{ request()->routeIs('showcase.launch.list') ? 'active' : '' }}">
                        <span class="aiz-side-nav-text">{{ translate('Launch List') }}</span>
                    </a>
                </li>
            </ul>
       </li>
       ...
       <li class="aiz-side-nav-item">
            <a href="{{ route('blog.index') }}"
                ...
                <span class="aiz-side-nav-text">{{ translate('Write') }}</span>
            </a>
       </li>
       @endcan
    </ul>
