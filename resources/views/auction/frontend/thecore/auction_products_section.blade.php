        ...
        <div class="row gutters-16">
            ...
            <div class="col-xl-8 col-lg-6">
                <div class="rounded-75 auction-product-box px-3 pt-4 pb-2" style="background: {{ get_setting('auction_product_bg_color', '#C7B198') }}">
                    ...
                    <div class="d-flex mb-2 align-items-baseline justify-content-between px-3">
                        <!-- Title -->
                                            ...
                                            <div class="row hov-scale-img">
                                                <div class="col-5">
                                                    <a href="{{ route('auction-product', $product->slug) }}" class="d-block overflow-hidden h-100px h-sm-120px h-md-140px text-center p-2">
                                                        <img class="img-fluid h-100 lazyload mx-auto has-transition rounded-2"
                                                            src="{{ static_asset('assets/img/placeholder.jpg') }}"
                                                ...
                                                <div class="col p-2 ">
                                                    ...
                                                    @endphp
                                                    <button class="btn custom-hov-btn text-white btn-sm rounded-1 mt-1" onclick="bid_single_modal({{ $product->id }}, {{ $min_bid_amount }})" style="background-color: {{ get_setting('auction_product_btn_color') ? get_setting('auction_product_btn_color') : '#C7B198' }};">{{ translate('Place Bid') }}</button>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
