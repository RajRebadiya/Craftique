...
<div class="row">
    <div class="col-lg-8 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form id="add_form" class="form-horizontal" action="{{ route('seller.blog.update',$blog->id) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{ translate('Select Products') }}</label>
                        <div class="col-md-9">
                            @php
                                $selectedProductIds = is_array($blog->product_ids ?? null) ? $blog->product_ids : [];
                            @endphp
                            <select name="product_ids[]" class="form-control aiz-selectpicker" multiple data-live-search="true" data-selected-text-format="count">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{ translate('Hashtags') }}</label>
                        <div class="col-md-9">
                            @include('partials.hashtag_input', [
                                'hashtagsValue' => $blog->hashtags ?? '',
                                'fieldName' => 'hashtags',
                                'labelText' => 'Hashtags',
                                'showLabel' => false
                            ])
