    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="javascript:void(0);" class="aiz-side-nav-link {{ areActiveRoutes(['seller.showcase.index', 'seller.showcase.history.index', 'seller.showcase.collection.index', 'seller.showcase.vitrin.index', 'seller.showcase.launch.index', 'seller.blog.index', 'seller.blog.create', 'seller.blog.edit']) }}">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.showcase.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['seller.showcase.index']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Showcase Center') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.showcase.history.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['seller.showcase.history.index', 'seller.showcase.history.create', 'seller.showcase.history.edit']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Story') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.showcase.collection.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['seller.showcase.collection.index', 'seller.showcase.collection.create', 'seller.showcase.collection.edit']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Collections') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.showcase.vitrin.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['seller.showcase.vitrin.index', 'seller.showcase.vitrin.create', 'seller.showcase.vitrin.edit']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Storefront') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.showcase.launch.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['seller.showcase.launch.index', 'seller.showcase.launch.create', 'seller.showcase.launch.edit']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Launch') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.blog.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['seller.blog.index', 'seller.blog.create', 'seller.blog.edit']) }}">
