<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group mb-3">
            <label class="mb-1 text-muted">{{ translate('Category') }}</label>
        ...
        <div class="form-group mb-3">
            <label class="mb-1 text-muted">{{ translate('Subcategory') }}</label>
        ...
        <div class="form-group mb-3">
            <label class="aiz-checkbox">
                ...
                <span class="text-muted">{{ translate('Auto-select all products from selected category/subcategory') }}</span>
                <span class="aiz-square-check"></span>
            </label>
        </div>

        <div class="form-group mb-3">
            <input type="text" class="form-control" id="showcaseProductSearch" placeholder="{{ translate('Search products...') }}">
        </div>
