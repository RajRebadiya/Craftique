        ...
        <div class="card-body p-0">
            ...
            <form class="p-4" action="{{ route('seller_packages.update', $seller_package->id) }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" min="0" step="1" placeholder="{{translate('Leave empty for unlimited')}}" value="{{ $seller_package->showcase_post_limit }}" id="showcase_post_limit" name="showcase_post_limit" class="form-control">
