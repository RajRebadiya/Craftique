...
@if($homepageShowcaseItems->count())
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap mb-3" style="gap:12px;">
                <div>
                    ...
                    <p class="text-muted mb-0">
                        {{ translate('Latest stories from creators, shown just like the live preview.') }}
                    </p>
                </div>

                <div class="d-flex align-items-center flex-wrap" style="gap:10px;">
                    <a href="{{ \Illuminate\Support\Facades\Route::has('frontend.showcase.story_page') ? route('frontend.showcase.story_page') : url('/showcase/story') }}"
                       class="btn btn-outline-secondary btn-sm">
                        {{ translate('View Page') }}
                    </a>
                    <a href="{{ route('frontend.showcase.index', ['type' => 'history']) }}"
                        ...
                        <div class="showcase-story-home__card-inner">
                            <div class="showcase-story-home__head">
                                <div class="showcase-story-home__shop">
                                    @if($shopUrl)
                                        <a href="{{ $shopUrl }}" class="showcase-story-home__logo">
                                            @if($sellerLogoUrl)
                                                <img src="{{ $sellerLogoUrl }}" alt="{{ $item->seller_name ?: $itemTitle }}">
                                            @else
                                    ...
                                    <div class="showcase-story-home__shop-meta">
                                        @if(!empty($item->seller_name))
                                            @if($shopUrl)
                                                <a href="{{ $shopUrl }}" class="showcase-story-home__shop-name">
                                                    {{ \Illuminate\Support\Str::limit($item->seller_name, 22) }}
                                                </a>
                                            @else
                                        ...
                                        @if($sellerBrandUrl)
                                            <a href="{{ $sellerBrandUrl }}" class="showcase-story-home__shop-type showcase-story-home__shop-type--link">
                                                {{ translate('Brand') }}
                                            </a>
                                        @else
                                            <div class="showcase-story-home__shop-type">{{ translate('Story') }}</div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                @else
                                    <a href="{{ $followUrl }}" class="showcase-story-home__follow">
                                        {{ translate('Follow') }}
                                    </a>
                                @endif
                            </div>
                            ...
                            <button type="button"
                                    ...
                                    onclick="{{ $storyModalAction }}">
                                @if($visualUrl && $visualIsVideo)
                                    <video muted playsinline preload="metadata" poster="">
                                        <source src="{{ $visualUrl }}">
                                    </video>
                                    <span class="showcase-story-home__video-badge">{{ translate('Video') }}</span>
                                @elseif($visualUrl)
                                    <img src="{{ $visualUrl }}" alt="{{ $itemTitle }}">
                                @else
                                ...
                                <span class="showcase-story-home__media-meta">
                                    <span class="showcase-story-home__title">
                                        {{ \Illuminate\Support\Str::limit($itemTitle, 42) }}
                                    </span>

                                    @if($itemHashtags->isNotEmpty())
                                ...
                                <div class="showcase-story-home__product-link"
                                    ...
                                    <div class="showcase-story-home__product-summary">
                                        <div class="showcase-story-home__product-thumb">
                                            @if($productThumb)
                                                <img src="{{ $productThumb }}" alt="{{ $linkedProduct->name ?? $itemTitle }}">
                                            @endif
                                        </div>

                                        <div class="showcase-story-home__product-meta">
                                            <div class="showcase-story-home__product-name">
                                                {{ $linkedProduct ? \Illuminate\Support\Str::limit($linkedProduct->name, 24) : translate('No product found') }}
                                            </div>
                                            <div class="showcase-story-home__product-price">
                                                {!! $linkedProduct ? single_price($finalPrice) : '&nbsp;' !!}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <button type="button"
                                            ...
                                            onclick="event.stopPropagation(); {{ $storyModalAction }}">
    ...
    <script>
        (function() {
            var homeStoryPreviewData = @json($homeStoryPreviewPayload);
                    ...
                    '<div class="story-product-modal__layout">' +
                        '<div class="story-product-modal__details">' +
                            '<div class="story-product-modal__shop-row">' +
                                ...
                                shopName +
                                '<button type="button" class="story-product-modal__follow">{{ translate('Follow') }}</button>' +
                            '</div>' +
                            ...
                            '<div class="story-product-modal__product-area">' +
                                ...
                                '<div class="story-product-modal__gallery">' +
                                    '<div class="story-product-modal__gallery-image">' +
                                        productImage +
                                        '<button type="button" class="story-product-modal__gallery-btn" onclick="navigateHomeStoryProductPreviewProduct(1)" aria-label="{{ translate('Next product') }}"' + (products.length > 1 ? '' : ' style="display:none;"') + '><i class="las la-angle-right"></i></button>' +
                                        '<button type="button" class="story-product-modal__expand" aria-label="{{ translate('Preview') }}"><i class="las la-expand"></i></button>' +
                                    '</div>' +
                                    '<div class="story-product-modal__summary">' +
                                        '<div class="story-product-modal__title">' + escapeHomeStoryHtml(product.name || '') + '</div>' +
                                        '<div class="story-product-modal__brand-line">{{ translate('Brand') }} <strong>Lucky Brand</strong></div>' +
                                        ...
                                        '<div class="story-product-modal__ask"><i class="las la-question-circle"></i> {{ translate('Ask about this product') }}</div>' +
                                        '<div class="story-product-modal__deal"><span>{{ translate('Todays Deal') }}</span><span>{{ translate('Exclusive for today only') }}</span></div>' +
                                        '<div class="story-product-modal__pricing">' +
                                            '<div class="story-product-modal__price">' + (product.price_html || '') + ' <span class="story-product-modal__brand-line">{{ translate('Piece') }}</span></div>' +
                                        ...
                                        '<div class="story-product-modal__buy">' +
                                            ...
                                            '<div class="story-product-modal__actions">' +
                                                '<button type="button" class="story-product-modal__buy-now" onclick="showAddToCartModal(' + product.id + ')">{{ translate('Buy Now') }}</button>' +
                                                '<button type="button" class="story-product-modal__cart" onclick="showAddToCartModal(' + product.id + ')">{{ translate('Add to cart') }} (01)</button>' +
                                            '</div>' +
                                        '</div>' +
                                        (categories ? '<div class="story-product-modal__brand-line mt-2">{{ translate('Categories') }}: ' + escapeHomeStoryHtml(categories) + '</div>' : '') +
                                    '</div>' +
                                '</div>' +
                            '</div>' +
                        '</div>' +
        ...
        function showShowcaseEmptyProductModal() {
            ...
            $('#addToCart-modal-body').html(
                '<div class="p-4 p-md-5 text-center">' +
                    '<h4 class="fw-700 mb-2">{{ translate('No product found') }}</h4>' +
                    '<p class="text-muted mb-0">{{ translate('There is no linked product available for this story right now.') }}</p>' +
                '</div>'
            );
            $('.c-preloader').hide();
            $('#addToCart').modal();
...
@if($launchPayload->count())
    <section class="showcase-launch-home mb-4">
        <div class="container">
            <div class="d-flex align-items-center justify-content-between flex-wrap mb-3" style="gap:12px;">
                <div>
                    <h3 class="h4 fw-700 mb-1">{{ translate('Launches') }}</h3>
                    <p class="text-muted mb-0">
                        {{ translate('Launch previews styled like the backend preview.') }}
                    </p>
                </div>

                <div class="d-flex align-items-center flex-wrap" style="gap:8px;">
                    <a href="{{ \Illuminate\Support\Facades\Route::has('frontend.showcase.launch_page') ? route('frontend.showcase.launch_page') : url('/showcase/launch-page') }}"
                       class="btn btn-outline-primary btn-sm">
                        {{ translate('View Page') }}
                    </a>
                    <a href="{{ route('frontend.showcase.index', ['type' => 'launch']) }}"
                       class="btn btn-soft-primary btn-sm">
                        {{ translate('View All') }}
                    </a>
                </div>
            ...
            <div class="showcase-launch-home__rail-wrap">
                ...
                <div class="showcase-launch-home__rail" data-launch-rail>
                    @foreach($launchPayload as $launch)
                        @php
                            ...
                            <div class="showcase-launch-home__card-inner">
                                <div class="showcase-launch-home__head">
                                    <div class="showcase-launch-home__shop">
                                        <a href="{{ $launchShopUrl }}" class="showcase-launch-home__logo">
                                            @if(!empty($launch['seller_logo_url']))
                                                <img src="{{ $launch['seller_logo_url'] }}" alt="{{ $launch['seller_name'] }}">
                                            @else
                                                <span>{{ $sellerInitial }}</span>
                                            @endif
                                        </a>
                                        <a href="{{ $launchShopUrl }}" class="showcase-launch-home__shop-name">{{ $launch['seller_name'] }}</a>
                                    </div>
                                    @if($launchIsFollowing)
                                        <div class="showcase-follow-menu">
                                            <button type="button" class="showcase-launch-home__follow showcase-follow-menu__toggle">
                                                {{ translate('Following') }} <i class="las la-angle-down"></i>
                                            </button>
                                            <div class="showcase-follow-menu__dropdown">
                                                <a href="{{ $launchFollowUrl }}">{{ translate('Unfollow') }}</a>
                                            </div>
                                        </div>
                                    @else
                                        <a href="{{ $launchFollowUrl }}" class="showcase-launch-home__follow">
                                            {{ translate('Follow') }}
                                        </a>
                                    @endif
                                </div>
                                ...
                                <div class="showcase-launch-home__visuals">
                                    <div class="showcase-launch-home__main-visual">
                                        @if(!empty($launch['main_visual_url']))
                                            <img src="{{ $launch['main_visual_url'] }}" alt="{{ $launch['title'] }}">
                                        @endif
                                    </div>
                                    <div class="showcase-launch-home__side-visual">
                                        @if(!empty($launch['side_visual_url']))
                                            <img src="{{ $launch['side_visual_url'] }}" alt="{{ $launch['title'] }}">
                                        @endif
                                    </div>
                                </div>

                                <a href="{{ $launchBrandUrl }}" class="showcase-launch-home__brand">{{ translate('LUCKY BRAND') }}</a>
                                <div class="showcase-launch-home__title">{{ \Illuminate\Support\Str::limit($launch['title'], 28) }}</div>
                                <div class="showcase-launch-home__subtitle">{{ \Illuminate\Support\Str::limit($launch['subtitle'], 40) }}</div>
                                <div class="showcase-launch-home__desc">{{ \Illuminate\Support\Str::limit(strip_tags($launch['description']), 64) }}</div>

                                <div class="showcase-launch-home__tags">
                                    @foreach(array_slice($launch['hashtags'], 0, 3) as $tag)
                                        <span>#{{ $tag }}</span>
                                    @endforeach
                                </div>

                                <div class="showcase-launch-home__product">
                                    @if(!empty($launch['product']))
                                        <div class="showcase-launch-home__product-card">
                                            <div class="showcase-launch-home__product-thumb">
                                                @if(!empty($launch['product']['thumbnail_url']))
                                                    <img src="{{ $launch['product']['thumbnail_url'] }}" alt="{{ $launch['product']['name'] }}">
                                                @endif
                                            </div>
                                            <div class="showcase-launch-home__product-name">
                                                {{ \Illuminate\Support\Str::limit($launch['product']['name'], 24) }}
                                            </div>
                                            <div class="showcase-launch-home__product-price">
                                                {{ $launch['product']['price_html'] }}
                                            </div>
                                        </div>
                                    @else
                                ...
                                <button type="button"
                                        ...
                                        @if(!empty($launch['product']))
                                            onclick="showAddToCartModal({{ $launch['product']['id'] }})"
                                        @else
...
@if($storefrontPayload->count())
    <section class="showcase-storefront-home mb-4">
        <div class="container">
            <div class="d-flex align-items-center justify-content-between flex-wrap mb-3" style="gap:12px;">
                <div>
                    <h3 class="h4 fw-700 mb-1">{{ translate('Storefronts') }}</h3>
                    <p class="text-muted mb-0">
                        {{ translate('Storefront previews styled like the backend preview.') }}
                    </p>
                </div>

                <div class="d-flex align-items-center flex-wrap" style="gap:8px;">
                    <a href="{{ \Illuminate\Support\Facades\Route::has('frontend.showcase.storefront_page') ? route('frontend.showcase.storefront_page') : url('/showcase/storefront-page') }}"
                       class="btn btn-outline-primary btn-sm">
                        {{ translate('View Page') }}
                    </a>
                    <a href="{{ route('frontend.showcase.index', ['type' => 'vitrin']) }}"
                       class="btn btn-soft-primary btn-sm">
                        {{ translate('View All') }}
                    </a>
                </div>
            ...
            <div class="showcase-storefront-home__rail-wrap">
                ...
                <div class="showcase-storefront-home__rail" data-storefront-rail>
                    @foreach($storefrontPayload as $storefront)
                        @php
                            ...
                            <div class="showcase-storefront-home__card-inner">
                                <div class="showcase-storefront-home__head">
                                    <div class="showcase-storefront-home__shop">
                                        <a href="{{ $storefrontShopUrl }}" class="showcase-storefront-home__logo">
                                            @if(!empty($storefront['seller_logo_url']))
                                                <img src="{{ $storefront['seller_logo_url'] }}" alt="{{ $storefront['seller_name'] }}">
                                            @else
                                                <span>{{ $sellerInitial }}</span>
                                            @endif
                                        </a>
                                        ...
                                        <div class="showcase-storefront-home__shop-meta">
                                            <a href="{{ $storefrontShopUrl }}" class="showcase-storefront-home__shop-name">
                                                {{ \Illuminate\Support\Str::limit($storefront['seller_name'], 22) }}
                                            </a>
                                            <a href="{{ $storefrontBrandUrl }}" class="showcase-storefront-home__shop-brand">{{ translate('lucky Brand') }}</a>
                                        </div>
                                    </div>

                                    @if($storefrontIsFollowing)
                                        <div class="showcase-follow-menu">
                                            <button type="button" class="showcase-storefront-home__follow showcase-follow-menu__toggle">
                                                {{ translate('Following') }} <i class="las la-angle-down"></i>
                                            </button>
                                            <div class="showcase-follow-menu__dropdown">
                                                <a href="{{ $storefrontFollowUrl }}">{{ translate('Unfollow') }}</a>
                                            </div>
                                        </div>
                                    @else
                                        <a href="{{ $storefrontFollowUrl }}" class="showcase-storefront-home__follow">
                                            {{ translate('Follow') }}
                                        </a>
                                    @endif
                                </div>
                                ...
                                <div class="showcase-storefront-home__title">
                                    {{ \Illuminate\Support\Str::limit($storefront['title'], 32) }}
                                </div>

                                @if(!empty($storefront['description']))
                                    <div class="showcase-storefront-home__desc">
                                        {{ \Illuminate\Support\Str::limit(strip_tags($storefront['description']), 48) }}
                                    </div>
                                @endif

                                <div class="showcase-storefront-home__media">
                                    @if(!empty($storefront['main_visual_url']))
                                        <img src="{{ $storefront['main_visual_url'] }}" alt="{{ $storefront['title'] }}">
                                    @endif
                                </div>

                                <div class="showcase-storefront-home__thumb-slider{{ count($storefront['products'] ?? []) > 3 ? ' has-arrows' : '' }}">
                                    <button type="button"
                                            class="showcase-storefront-home__thumb-arrow showcase-storefront-home__thumb-arrow--left"
                                            data-storefront-thumb-scroll="left"
                                            aria-label="{{ translate('Previous products') }}">
                                        <i class="las la-angle-left"></i>
                                    </button>

                                    <div class="showcase-storefront-home__thumbs" data-storefront-thumb-rail>
                                        @forelse($storefront['products'] as $thumbProduct)
                                            <div class="showcase-storefront-home__thumb">
                                                @if(!empty($thumbProduct['thumbnail_url']))
                                                    <img src="{{ $thumbProduct['thumbnail_url'] }}" alt="{{ $thumbProduct['name'] }}">
                                                @endif
                                            </div>
                                        @empty
                                            @foreach(range(0, 2) as $emptyThumbIndex)
    ...
    <script>
        (function() {
            var storefrontData = @json($storefrontPayload);
            var storefrontMap = {};
            ...
            window.openShowcaseStorefrontModal = function(storefrontId) {
                ...
                modalBody.innerHTML =
                    '<div class="showcase-storefront-modal__wrap">' +
                        '<div class="showcase-storefront-modal__head">' +
                            '<div class="showcase-storefront-modal__shop">' +
                                '<div class="showcase-storefront-modal__logo">' +
                                    (storefront.seller_slug ? '<a href="{{ url('/shop') }}/' + storefront.seller_slug + '">' : '') +
                                ...
                                '</div>' +
                                '<div>' +
                                    '<a class="showcase-storefront-modal__shop-name" href="{{ url('/shop') }}/' + (storefront.seller_slug || '') + '">' + (storefront.seller_name || '') + '</a>' +
                                    '<a class="showcase-storefront-modal__shop-brand" href="{{ url('/showcase/brand') }}/' + (storefront.seller_slug || '') + '">lucky Brand</a>' +
                                '</div>' +
                            '</div>' +
                            '<button type="button" class="showcase-storefront-modal__follow">{{ translate('Follow') }}</button>' +
                        '</div>' +
                        ...
                        '</div>' +
                        '<div class="showcase-storefront-modal__label">{{ translate('Shop our selection') }}</div>' +
                                ...
                                return '' +
                                    '<div class="showcase-storefront-modal__product">' +
                                        ...
                                        '<div class="showcase-storefront-modal__product-body">' +
                                            ...
                                            '<button type="button" class="showcase-storefront-modal__product-btn" onclick="showAddToCartModal(' + product.id + ')">{{ translate('Add to cart') }}</button>' +
                                        '</div>' +
                                    '</div>';
                            }).join('') +
                        '</div>' +
...
@if($collectionPayload->count())
    <section class="showcase-collection-home mb-4">
        <div class="container">
            <div class="d-flex align-items-center justify-content-between flex-wrap mb-3" style="gap:12px;">
                <div>
                    <h3 class="h4 fw-700 mb-1">{{ translate('Collections') }}</h3>
                    <p class="text-muted mb-0">
                        {{ translate('Featured collection previews styled like the backend preview.') }}
                    </p>
                </div>

                <div class="d-flex align-items-center flex-wrap" style="gap:10px;">
                    <a href="{{ \Illuminate\Support\Facades\Route::has('frontend.showcase.collection_page') ? route('frontend.showcase.collection_page') : url('/showcase/collection-page') }}"
                       class="btn btn-outline-secondary btn-sm">
                        {{ translate('View Page') }}
                    </a>
                    <a href="{{ route('frontend.showcase.index', ['type' => 'collection']) }}"
                       class="btn btn-soft-primary btn-sm">
                        {{ translate('View All') }}
                    </a>
                </div>
            ...
            <div class="showcase-collection-home__rail-wrap">
                ...
                <div class="showcase-collection-home__rail" data-collection-rail>
                    @foreach($collectionPayload as $collection)
                        @php
                            ...
                            <div class="showcase-collection-home__card-inner">
                                <div class="showcase-collection-home__head">
                                    <div class="showcase-collection-home__shop">
                                        <a href="{{ $collectionShopUrl }}" class="showcase-collection-home__logo">
                                            @if(!empty($collection['seller_logo_url']))
                                                <img src="{{ $collection['seller_logo_url'] }}" alt="{{ $collection['seller_name'] }}">
                                            @else
                                                <span>{{ $sellerInitial }}</span>
                                            @endif
                                        </a>
                                        <div class="showcase-collection-home__shop-meta">
                                            <a href="{{ $collectionBrandUrl }}" class="showcase-collection-home__shop-name">
                                                {{ \Illuminate\Support\Str::limit($collection['title'], 24) }}
                                            </a>
                                            <div class="showcase-collection-home__shop-type">
                                                {{ translate('By') }} - <a href="{{ $collectionShopUrl }}">{{ $collection['seller_name'] }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="showcase-collection-home__preview">
                                    @if(!empty($collection['description']))
                                        <div class="showcase-collection-home__desc">
                                            {{ \Illuminate\Support\Str::limit(strip_tags($collection['description']), 50) }}
                                        </div>
                                    @endif
                                    @if(!empty($collection['hashtags']))
                                        <div class="showcase-collection-home__hashtags">
                                            @foreach(array_slice($collection['hashtags'], 0, 3) as $tag)
                                                <span>#{{ $tag }}</span>
                                            @endforeach
                                        </div>
                                    @endif
                                    ...
                                    <div class="showcase-collection-home__slider">
                                        <button type="button"
                                                ...
                                                aria-label="{{ translate('Previous item') }}">
                                            &lsaquo;
                                        </button>

                                        <div class="showcase-collection-home__media" data-collection-media>
                                            @if(!empty($firstCollectionItem['cover_image_url']))
                                                <img src="{{ $firstCollectionItem['cover_image_url'] }}" alt="{{ $firstCollectionItem['title'] }}">
                                            @endif
                                        </div>
                                        ...
                                        <button type="button"
                                                ...
                                                aria-label="{{ translate('Next item') }}">
                                            &rsaquo;
                                        </button>
                                    </div>

                                    <div class="showcase-collection-home__active-title" data-collection-active-title>
                                        {{ $firstCollectionItem['title'] ?? translate('Collection Item') }}
                                    </div>
                                    <div class="showcase-collection-home__active-desc" data-collection-active-desc>
                                        {{ !empty($firstCollectionItem['description']) ? \Illuminate\Support\Str::limit(strip_tags($firstCollectionItem['description']), 58) : '' }}
                                    </div>

                                    <div class="showcase-collection-home__linked" data-collection-product>
                                        @if(!empty($firstCollectionItem['product']))
                                            <div class="showcase-collection-home__linked-card">
                                                <div class="showcase-collection-home__linked-tools">
                                                    <button type="button"
                                                            ...
                                                            onclick='shareShowcaseCollectionProduct(@json($firstCollectionItem['product']['product_url'] ?? ''), @json($firstCollectionItem['product']['name'] ?? ''))'
                                                            aria-label="{{ translate('Share product') }}">
                                                        <i class="las la-share-alt"></i>
                                                    </button>
                                                    <button type="button"
                                                            class="showcase-collection-home__tool-btn"
                                                            onclick='copyShowcaseCollectionProduct(@json($firstCollectionItem['product']['product_url'] ?? ''))'
                                                            aria-label="{{ translate('Copy product link') }}">
                                                        <i class="las la-code"></i>
                                                    </button>
                                                </div>
                                                <div class="showcase-collection-home__linked-thumb">
                                                    @if(!empty($firstCollectionItem['product']['thumbnail_url']))
                                                        <img src="{{ $firstCollectionItem['product']['thumbnail_url'] }}" alt="{{ $firstCollectionItem['product']['name'] }}">
                                                    @endif
                                                </div>
                                                <div class="showcase-collection-home__linked-body">
                                                    <div class="showcase-collection-home__linked-name">
                                                        {{ \Illuminate\Support\Str::words($firstCollectionItem['product']['name'], 3, '...') }}
                                                    </div>
                                                    <div class="showcase-collection-home__linked-price">
                                                        {{ $firstCollectionItem['product']['price_html'] }}
                                                    </div>
                                                </div>
                                                <button type="button"
                                                        class="showcase-collection-home__cart-btn"
                                                        onclick="showAddToCartModal({{ $firstCollectionItem['product']['id'] }})"
                                    ...
                                    <button type="button"
                                            ...
                                            onclick="openShowcaseCollectionModal({{ $collection['id'] }})">
    ...
    <script>
        (function() {
            var collectionData = @json($collectionPayload);
            var collectionMap = {};
                ...
                modalBody.innerHTML =
                    '<div class="showcase-collection-modal__wrap">' +
                        '<div class="showcase-collection-modal__head">' +
                            ...
                            '<div class="showcase-collection-modal__meta">{{ translate('By') }} <a href="{{ url('/shop') }}/' + (collection.seller_slug || '') + '">' + (collection.seller_name || '') + '</a></div>' +
                                        ...
                                        (product ? '' +
                                            '<div class="showcase-collection-modal__product">' +
                                                ...
                                                '<div class="showcase-collection-modal__actions">' +
                                                    '<button type="button" class="showcase-collection-modal__cart" onclick="showAddToCartModal(' + product.id + ')">{{ translate('Add to cart') }}</button>' +
                                                '</div>' +
                                            '</div>' +
                                            '<button type="button" class="showcase-collection-modal__view" onclick="showAddToCartModal(' + product.id + ')">{{ translate('View Product') }}</button>'
                                            : '<button type="button" class="showcase-collection-modal__view" onclick="showShowcaseEmptyProductModal()">{{ translate('View Product') }}</button>') +
                                    '</div>';
                            }).join('') +
                        '</div>' +
                    '</div>';
                        ...
                        if (productWrap) {
                            if (item.product) {
                                ...
                                productWrap.innerHTML =
                                    '<div class="showcase-collection-home__linked-card">' +
                                        '<div class="showcase-collection-home__linked-tools">' +
                                            '<button type="button" class="showcase-collection-home__tool-btn" onclick="shareShowcaseCollectionProduct(' + JSON.stringify(productUrl) + ', ' + JSON.stringify(productName) + ')" aria-label="{{ translate('Share product') }}">' +
                                                '<i class="las la-share-alt"></i>' +
                                            '</button>' +
                                            '<button type="button" class="showcase-collection-home__tool-btn" onclick="copyShowcaseCollectionProduct(' + JSON.stringify(productUrl) + ')" aria-label="{{ translate('Copy product link') }}">' +
                                                '<i class="las la-code"></i>' +
                                            '</button>' +
                                        '</div>' +
                                        '<div class="showcase-collection-home__linked-thumb">' +
                                        ...
                                        '</div>' +
                                        '<button type="button" class="showcase-collection-home__cart-btn" onclick="showAddToCartModal(' + item.product.id + ')" aria-label="{{ translate('Add to cart') }}">' +
                                            '<i class="las la-shopping-cart"></i>' +
                                        '</button>' +
                                    '</div>';
                            } else {
