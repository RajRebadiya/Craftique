...
@section('content')
    @php
        $pageTypeLabel = translate('Story');
        $feedUrl = route('frontend.showcase.index', ['type' => 'history']);
            ...
            <div class="bg-white border rounded shadow-sm p-4">
                <div class="row align-items-center">
                    <div class="col-lg-8 mb-3 mb-lg-0">
                        ...
                        <h1 class="h3 fw-700 mb-2">{{ translate('Story Showcase') }}</h1>
                        <p class="text-muted mb-0">
                            {{ translate('Latest published Story from the Showcase feed.') }}
                        </p>
                    </div>
                ...
                <div class="container">
                    <div class="d-flex align-items-center justify-content-between flex-wrap mb-3" style="gap:12px;">
                        <div>
                            ...
                            <p class="text-muted mb-0">{{ translate('Products linked with this Story.') }}</p>
                        </div>
                    </div>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center py-5">
                        ...
                        <p class="text-muted mb-3">
                            {{ translate('There is no published Story available right now.') }}
                        </p>
